...
\begin{figure}[H]
    \includegraphics[width=16cm]{images/diag_norm_usr.drawio.png}\\
    \caption{Schema scheletro della vista dell'Utente}
\end{figure}
...
As shown in previous studies~\cite{exampleReference}, the proposed system has significant potential.
