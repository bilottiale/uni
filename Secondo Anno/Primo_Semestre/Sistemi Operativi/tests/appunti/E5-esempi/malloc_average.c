/*
 * malloc_average.c - allocazione di un po'
 *                    di memoria via malloc()
 *
 * Si usa la funzione di libreria malloc() per allocare
 * 4KB di memoria. Tale memoria dovrebbe essere presa
...
int main (void)
{
	...
	/*
	 * Si alloca dinamicamente un'area di memoria di 4KB.
	 */
