/*
 * mmap_anon.c - esempio di mappatura anonima
 *
 * La chiamata di sistema mmap() consente di
 * creare una mappatura anonima. Successivamente
 * si prova a scrivere il carattere 'A' nella
 * mappatura. 
 */
