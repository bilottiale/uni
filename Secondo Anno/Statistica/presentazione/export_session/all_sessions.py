...
start_year = 2005 # Anno di inizio del campionato
end_year = 2024

# Nome del circuito da filtrare
target_event_name = "Italian Grand Prix"
...
if all_laps_weather_data:
    ...
    combined_output_file = os.path.join(output_dir, 'italian_grand_prix_data.csv')
