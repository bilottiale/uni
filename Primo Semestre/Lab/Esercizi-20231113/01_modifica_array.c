...
size_t filtra_maggiori_di(int *pA, size_t lenA, int maggori_di);
...
int main(void)
{
    ...
    int arr3[NBUF3];
    size_t len3 = copia_nonnegativi(arr1, len1, arr3, NBUF3);
    ...
    puts("63 99 56 56 98 98 59 51 12 12 57 10 10 85    [atteso]\n");
...
#define LENRISP1 4
    ...
    printf("%d  [atteso: 0]\n", array_equal(arr1, len1, arr2, arr2));
