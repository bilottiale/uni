...
// e2R delle lunghezze di tutte le righe i di mat per le quali esiste almeno un'occorrenza dell'elemento val lungo la riga.

// (Suggerimento: scrivere una ulteriore funzione ricorsiva esiste_val_in_arrayR)

#include <stdio.h>
#include <stdbool.h>

bool esiste_val_in_arrayR
